### supplemental growth curve - WT + BrkA
...
wtbrka_clean <- full_join(wtbrka_avg, wtbrka_sd) |>
  select(!(n:conc_sd))

#reorder data by EDTA concentration condition
wtbrka_clean$conc <- factor(wtbrka_clean$conc , levels = x_order)
